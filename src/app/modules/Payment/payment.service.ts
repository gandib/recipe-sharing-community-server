...
const initiatePayment = async (paymentData: any) => {
  ...
  try {
    const response = await axios.post(config.payment_url!, {
      ...
      success_url: `https://recipe-sharing-community-server-beryl.vercel.app/api/payment/confirmation?transactionId=${paymentData.userId}-${paymentData.transactionId}&status=success&validity=${paymentData.validity}`,
      fail_url: `https://recipe-sharing-community-server-beryl.vercel.app/api/payment/confirmation?status=failed`,
      cancel_url: 'https://recipe-sharing-community-client-silk.vercel.app',
